...
import org.refutix.refutix.server.data.model.TableColumn;
import org.refutix.refutix.server.data.result.R;
import org.refutix.refutix.server.util.ObjectMapperUtils;
import org.refutix.refutix.server.util.RefutixDataType;
...
public class TableControllerTest extends ControllerTestBase {
    ...
    public void testAddColumn() throws Exception {
        ...
        TableColumn age =
                new TableColumn(
                        "age",
                        RefutixDataType.builder().type("INT").isNullable(true).build(),
                        "",
                        false,
                        "0");
    ...
    public void testAlterTable() throws Exception {
        ...
        TableColumn newColumn =
                new TableColumn(
                        "age", RefutixDataType.builder().type("BIGINT").build(), "", false, "0");
